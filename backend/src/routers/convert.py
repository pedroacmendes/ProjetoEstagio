...
directory = './backend/src/files/modelo_tfjs/'
directory_final = './backend/src/files/model-ready/' + result + '/'
...
mycursor2.execute("SELECT description FROM object WHERE request_id = '"+result+"';")
